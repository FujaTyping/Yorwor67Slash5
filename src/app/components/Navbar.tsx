                ...
                <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div id="hs-navbar-example" className="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow sm:block" aria-labelledby="hs-navbar-example-collapse">
                        <div className="flex flex-col gap-5 mt-5 mb-5 sm:mb-0 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                            <a className="font-medium focus:outline-hidden flex items-center gap-2" href="#"><House size={16} /> หน้าหลัก</a>
                            <a className="font-medium focus:outline-hidden flex items-center gap-2" href="#"><Pencil size={16} /> ภาระงาน</a>
                            <a className="font-medium focus:outline-hidden flex items-center gap-2" href="#"><School size={16} /> รหัสห้องเรียน</a>
                            <a className="font-medium focus:outline-hidden flex items-center gap-2" href="#"><ChartArea size={16} /> สถิตินักเรียน</a>
                            <a className="font-medium focus:outline-hidden flex items-center gap-2" href="#"><PartyPopper size={16} /> กิจกรรม</a>
                        </div>
                    </div>
                </nav>
            </header>
