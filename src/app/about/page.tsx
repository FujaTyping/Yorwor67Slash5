...
export default function About() {
  ...
  return (
    <>
          ...
          <div className="mb-5 flex items-center justify-between gap-8 md:mb-6">
            <div className="flex flex-col md:flex-row items-center gap-3 md:gap-10">
              <span className="relative whitespace-nowrap ml-4">
                ...
                <h2 className="text-2xl font-bold lg:text-3xl dark:text-white">SMT</h2>
              </span>
              <p>
      ...
      <div style={{ marginTop: "-2.5rem" }} className="container font-bold">
        <Marquee gradient={true} gradientColor="white" gradientWidth={25}>
          <p>เรื่องคิดเลขอ่ะเกรดหนึ่ง เรื่องคิดถึงอ่ะเกรดสี่</p><FaCircle />
          <p>การบ้านเท่าภูเขา ความโง่เขลาเท่าจักรวาล</p><FaCircle />
          <p>งานเลี้ยงย่อมมีวันเลิกรา อาจาร์ยเข้าช้า ไม่มีวันเลิกเร็ว</p><FaCircle />
          <p>คำที่ครูบอกออกสอบ มักจะไม่เจอในข้อสอบเสมอ</p><FaCircle />
          <p>เรื่องเรียนเป็นเรื่องตลก สอบตกเป็นเรื่องธรรมดา</p><FaCircle />
        </Marquee>
      </div>
    </>
  );
