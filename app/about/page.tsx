            ...
            <section className="py-4 px-6 w-full">
                <div className="grid gap-8 md:grid-cols-2 items-center w-full">
                    <div className="space-y-4 w-full">
                        <h2 className="text-3xl font-bold tracking-tight">เกี่ยวกับห้อง ม.6/5</h2>
                        <p>
                            ห้อง ม.6/5 เป็นห้องเรียนเฉพาะทางด้านวิทยาศาสตร์ คณิตศาสตร์ และเทคโนโลยี สำหรับนักเรียนชั้นมัธยมศึกษาปีที่ 5 ซึ่งเน้นหลักสูตรขั้นสูงเพื่อเตรียมความพร้อมให้นักเรียนประสบความสำเร็จทางวิชาการในสาขา STEM ในอนาคต
                        </p>
                        <p>
                            โดยมีนักเรียน 35 คน ห้องเรียน ม.6/5 มอบสภาพแวดล้อมการเรียนรู้แบบร่วมมือกัน ที่นักเรียนมีส่วนร่วมในกระบวนการเรียนรู้แบบใช้โครงงานเป็นฐาน การสืบค้นทางวิทยาศาสตร์ และนวัตกรรมทางเทคโนโลยี
                        </p>
                ...
                <div>
                    <div className="text-center mb-4">
                        ...
                        <p className="mt-2 max-w-2xl mx-auto">
                            ม.6/5 มุ่งเน้นการศึกษาพิเศษในสามด้านหลักของ STEM
                        </p>
                    </div>
