  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h2 style={{ fontSize: '20px' }} id="h2Decs">ตารางเรียน ตารางสอนด้านล่างนี้เป็นฉบับปรับปรุง ครั้งที่ 3  <span style={{ color: 'red' }}>เริ่มใช้ตั้งแต่วันอังคารที่ 18 มิถุนายน พ.ศ.  2567 เป็นต้นไป</span><br></br>กรณีพบข้อผิดพลาด สามารถแจ้งข้อมูลได้ที่ สนง.วิชาการ 2</h2>
