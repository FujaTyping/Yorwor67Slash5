  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h2 style={{ fontSize: '18px' }}>ที่ Yorwor67Slash5 เราให้ความสำคัญกับความเป็นส่วนตัวของคุณ นโยบายนี้อธิบายการเก็บรวบรวมและการใช้ข้อมูลที่เกี่ยวข้องกับระบบการแจ้งเตือนของเรา ซึ่งช่วยให้นักเรียนจัดการการบ้านและรับข้อมูลอัปเดตผ่านแพลตฟอร์มต่าง ๆ เช่น Line และ Discord</h2>
        <List style={{ marginTop: '20px', fontSize: '18px' }}>
          <List.Item style={{ color: 'black' }}>การเก็บข้อมูล :
            เรารวบรวมข้อมูลพื้นฐาน เช่น ชื่อผู้ใช้ หรือ ID ของคุณบนแพลตฟอร์มที่เชื่อมต่อ เพื่อส่งการแจ้งเตือนเกี่ยวกับ การบ้าน ประกาศ และอัปเดตอื่น ๆ ที่เกี่ยวข้องกับห้องเรียน</List.Item>
