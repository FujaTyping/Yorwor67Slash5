...
import Banner1 from "../assets/Activities/Banner1.png";
import Banner2 from "../assets/Activities/Banner2.png";
import Banner3 from "../assets/Activities/Banner3.png";
import Banner4 from "../assets/Activities/Banner4.png";
import Banner5 from "../assets/Activities/Banner5.png";
import Banner6 from "../assets/Activities/Banner6.png";
    ...
    return (
        <>
            ...
            <div className="container">
                <h1 style={{ marginBottom: '20px' }} className="border-b">🎉 บันทึกกิจกรรม - Activities</h1>
                <Timeline>
                    <Timeline.Item>
                    ...
                    <Timeline.Item>
                        ...
                        <Timeline.Content>
                            ...
                            <Timeline.Body id="TimeDecs">
                                นักเรียนที่สนใจได้ไปแข่งขันหุ่นยนต์ กับ กิจกรรม PORNSIRIKUL INTERNATIONAL ROBOTIC COMPETITION
                            </Timeline.Body>
                        </Timeline.Content>
                    </Timeline.Item>
                    <Timeline.Item>
