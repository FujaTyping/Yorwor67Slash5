        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: "18px" }}>
              ...
              และเทคโนโลยี! หน้าเว็บที่คุณกำลังมองหาไม่มีอยู่ตรงนี้
              แต่ไม่ต้องห่วง! แม้แต่นักเรียนหัวกะทิในห้อง ม.4/5
              ก็อาจจะหลงทางได้บ้างเป็นบางครั้ง
            </p>
            <p
              className="font-bold"
              style={{ fontSize: "18px", marginTop: "15px" }}
            >
              กลับไปสำรวจสิ่งที่น่าสนใจกันต่อได้ที่
            </p>
