        ...
        <div style={{ paddingLeft: '0', paddingRight: '0' }} className="container">
          <div className="flex items-start gap-2.5 flex-wrap">
            <img
              ...
              alt="Cynthia"
            />
            <div className="flex flex-col w-full max-w-[380px] leading-1.5 p-4 bg-gray-50 border border-gray-300 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-600">
